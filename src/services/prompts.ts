...
Rules:
- Absolutely make sure that all four answer options are the same part of speech as the target word, i.e. if the expected answer is an adjective, provide adjectives only as the other 3 options; if the target word is a verb, provide verbs only as the other options; etc. — it's critical!
